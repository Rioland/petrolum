        ...
        <div className="container">
          <div className="row">
            ...
            <div className="col-sm-6 col-md-3">
              <div className="fun-fact text-center">
                <h3>
                  <i className="fa fa-coffee" /> <span className="timer">297345</span>
                </h3>
            ...
            <div className="col-sm-6 col-md-3">
              <div className="fun-fact text-center">
                <h3>
                  <i className="fa fa-code" /> <span className="timer">9823686</span>
                </h3>
                <h6>Lines of Code</h6>
              </div>
            </div>
    ...
    <div className="col-md-8 col-md-offset-2">
      <div className="heading">
        ...
        <p>
          ...
          orem ipsum dolor sit amet, consectetur adipisicing elit, sed do
          eiusmod tempor incididunt ut et dolore magna aliqua. Ut enim ad minim
          veniam
        </p>
      </div>
    </div>
...
export { Download, Nav, Fetures, Slider, About, Service, Teams, Testi,Fact,Portfoilo,Client,Contact,Footer,FooterDown };
